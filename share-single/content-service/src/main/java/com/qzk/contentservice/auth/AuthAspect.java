package com.qzk.contentservice.auth;


import com.qzk.contentservice.exception.SecurityException;
...
public class AuthAspect {
    ...
    @Around("@annotation(com.qzk.contentservice.auth.CheckLogin)")
    public Object checkLogin(ProceedingJoinPoint point) throws Throwable {
        checkToken();
        return point.proceed();
    }

    @Around("@annotation(com.qzk.contentservice.auth.CheckAuthorization)")
