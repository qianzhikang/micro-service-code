package com.qzk.userservice.utils;
...
public class JwtOperator {
    ...
    public static void main(String[] args) {
        ...
        jwtOperator.secret = "qzkqzkqzkqzkqzkqzkqzkqzkqzkqzkqzkqzkqzkqzkqzkqzkqzk";
        //jwtOperator.secret = "abc123";

        // //2.设置用户信息
        //HashMap<String, Object> objectObjectHashMap = Maps.newHashMap();
        //objectObjectHashMap.put("id", "1");
        //objectObjectHashMap.put("nickname", "qzk");
        ...
        //// 将这串字符还原为上面生成的token!!!
        String someToken = "eyJhbGciOiJIUzI1NiJ9.eyJyb2xlIjoiYWRtaW4iLCJ3eE5pY2tuYW1lIjoicXprIiwiaWQiOjEsImlhdCI6MTY2NDg3MjI1MCwiZXhwIjoxNjY2MDgxODUwfQ._V11rlJ-zYwEF4DDxWi1jNCrI9vRSZE5_sntwFm-NWU";
        ...
        // //token的第二段（以.为边界）
        //String encodedPayload = "eyJuaWNrbmFtZSI6InF6ayIsImlkIjoiMSIsImlhdCI6MTY2NDg2ODYwOSwiZXhwIjoxNjY2MDc4MjA5fQ";
        //////// 测试5: 解密Payload
